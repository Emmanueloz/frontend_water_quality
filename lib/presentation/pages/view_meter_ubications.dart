...
class ViewMeterUbications extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutWorkspace(
        title: "Ubicaciones de medidores",
        id: id,
        selectedIndex: 3,
        builder: (context, screenSize) => MainMapUbications(
          screenSize: screenSize,
          ubications: [
            // Example ubications, replace with actual data
            MeterUbication(name: "Medidor 1", latitude: 16.896614995293795, longitude: -92.06757293190135),
            MeterUbication(name: "Medidor 2", latitude: 16.742692572358138,  longitude: -92.65357023705555),
            MeterUbication(name: "Medidor 3", latitude: 16.747528402130893, longitude: -93.06934757476262),
          ],
        ),
        );
  }
