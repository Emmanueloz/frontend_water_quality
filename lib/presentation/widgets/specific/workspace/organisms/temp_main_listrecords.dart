...
/// Widget temporal para listado de registros del medidor.
/// Se puede modificar libremente sin afectar la versión principal.
class TempMainListrecords extends StatelessWidget {
  final String id;
  final String idMeter;
  final ScreenSize screenSize;

  const TempMainListrecords({
    super.key,
  ...
  Widget build(BuildContext context) {
    // Simplemente retornar el contenido, el LayoutTempMeter se encarga del Expanded
    ...
    return BaseContainer(
      ...
      child: Column(
        ...
        children: [
          // Título temporal
          Text(
            "Historial del medidor $idMeter (TEMP)",
